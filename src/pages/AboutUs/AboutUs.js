    ...
    const steps = useMemo(
        () => [
            ...
            },
            {
                ...
                summary:
                    'Collaborate with your tutor in the free, browser based OnDemandTutor Learning Studio.',
            },
            {
                image: images.different3,
                summary:
                    'Teaching methods to meet the learning needs of many students.',
            },
        ],
        [],
    );
